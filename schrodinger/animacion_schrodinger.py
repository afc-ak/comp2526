...
# Parámetros
# ========================================
file_in = "lam0.txt" # Nombre del fichero de datos
file_out = "animacion_schrodinger" # Nombre del fichero de salida (sin extensión)
...
if nframes > 1:
    ...
    if save_to_file:
        animation.save("animacion_schrodinger.mp4".format(file_out), dpi=dpi)
    else:
        plt.show()
